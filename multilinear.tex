...
involves finding connected subgraphs which maximize a suitable anomaly score, which
depends on the underlying application.
...
\input{preliminaries_v4.tex}
%\input{sequential_v3.tex}
\input{proposed-methods_v2.tex}
